...
class Game {
    ...
    public void drawMenu() {
        ...
        canvas.text("ASTEROIDS!", canvas.width/2, 40);

        canvas.text("SWE 3313 - Group One", canvas.width/2, 60);
        canvas.text("Hidden Mini-Game", canvas.width/2, 75);
    ...
    public void drawGameOver() {
        ...
        canvas.text("Press Enter to reset...", canvas.width/2, 95);
    }
    ...
    /**
     * This loops through the creatables and adds them to the object list.
